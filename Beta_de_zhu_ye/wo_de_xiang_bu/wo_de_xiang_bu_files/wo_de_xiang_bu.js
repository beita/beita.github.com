...
{var entryCount=imageStream.length;var headerView=widgets['widget6'];headerView.setPreferenceForKey(imageStream.length,'entryCount');NotificationCenter.postNotification(new IWNotification('SetPage','id4',{pageIndex:0}));});}
function layoutMediaGrid_id4(range)
{createMediaStream_id4().load('http://zhoudeming.com/Beta_de_zhu_ye/wo_de_xiang_bu',function(imageStream)
{if(range==null)
{range=new IWRange(0,imageStream.length);}
IWLayoutPhotoGrid('id4',new IWPhotoGridLayout(2,new IWSize(287,215),new IWSize(287,41),new IWSize(344,271),27,27,0,new IWSize(81,71)),new IWPhotoFrame([IWCreateImage('wo_de_xiang_bu_files/kids-blue_ul.png'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_top.jpg'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_ur.png'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_right.png'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_lr.png'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_bottom.png'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_ll.png'),IWCreateImage('wo_de_xiang_bu_files/kids-blue_left.png')],null,0,0.697368,0.000000,0.000000,0.000000,0.000000,71.000000,43.000000,44.000000,58.000000,100.000000,105.000000,100.000000,105.000000,null,null,null,0.300000),imageStream,range,(null),null,1.000000,null,'../Media/slideshow.html','widget6',null,'widget7',{showTitle:true,showMetric:true})});}
